...
#import "SinaUCImageAdditions.h"

@interface NSImage (SinaUCImageAdditions_PRIVATE)

- (NSBitmapImageRep *)bitmapRep;

@end

@implementation NSImage (SinaUCImageAdditions)
...
+ (NSString *)extensionForBitmapImageFileType:(SinaUCBitmapImageFileType)inFileType
{
	...
	switch (inFileType) {
		case SinaUCUnknownFileType:
			break;
		case SinaUCTIFFFileType:
			extension = @"tif";
			break;
		case SinaUCBMPFileType:
			extension = @"bmp";
			break;
		case SinaUCGIFFileType:
			extension = @"gif";
			break;
		case SinaUCJPEGFileType:
			extension = @"jpg";
			break;
		case SinaUCPNGFileType:
			extension = @"png";
			break;
		case SinaUCJPEG2000FileType:
			extension = @"jp2";
			break;
	}
