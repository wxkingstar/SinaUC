//
//  SinaUCVariableHeightOutlineView.m
//  SinaUC
//
...
//#import "SinaUCApplicationAdditions.h"
#import "SinaUCImageDrawingAdditions.h"
#import "SinaUCGradientAdditions.h"

#define	DRAG_IMAGE_FRACTION	0.75f

@interface SinaUCVariableHeightOutlineView ()
...
@implementation SinaUCVariableHeightOutlineView

+ (void)initialize
{
	if (self == [SinaUCVariableHeightOutlineView class]) {
...
- (void)_initVariableHeightOutlineView
{
	...
	[[NSNotificationCenter defaultCenter] addObserver:self
											 selector:@selector(itemDidExpand:)
												 name:SinaUCOutlineViewUserDidExpandItemNotification
											   object:self];
	[[NSNotificationCenter defaultCenter] addObserver:self
											 selector:@selector(itemDidCollapse:)
												 name:SinaUCOutlineViewUserDidCollapseItemNotification
											   object:self];
