...
@interface NSDictionary (SinaUCColorAdditions_RGBTxtFiles)
...
@interface NSColor (SinaUCColorAdditions_RGBTxtFiles)
...
@interface NSColor (SinaUCColorAdditions_Comparison)
...
@interface NSColor (SinaUCColorAdditions_DarknessAndContrast)
...
@interface NSColor (SinaUCColorAdditions_HLS)
...
@interface NSColor (SinaUCColorAdditions_RepresentingColors)
...
@interface NSString (SinaUCColorAdditions_RepresentingColors)
...
@interface NSColor (SinaUCColorAdditions_RandomColor)
...
@interface NSColor (SinaUCColorAdditions_HTMLSVGCSSColors)
...
@interface NSColor (SinaUCColorAdditions_ObjectColor)
