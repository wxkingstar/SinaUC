...
{
    XMPPSession *session = [[XMPPSession alloc] init];
    [session setContactInfo:contact];
    [session setSession:CXmpp::instance().createSession([contact valueForKey:@"jid"])];
