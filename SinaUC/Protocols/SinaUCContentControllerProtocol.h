...
#import "SinaUCControllerProtocol.h"
...
typedef enum {
	SinaUCFilterContent = 0,		// Changes actual message and non-message content
	SinaUCFilterDisplay,			// Changes only how non-message content is displayed locally (Profiles, aways, auto-replies, ...)
	SinaUCFilterMessageDisplay,  	// Changes only how messages are displayed locally
	SinaUCFilterTooltips,			// Changes only information displayed in contact tooltips
	SinaUCFilterContactList,		// Changes only information in statuses displayed in the contact list
	 ...
	 */
	SinaUCFilterAutoReplyContent
	
} SinaUCFilterType;
#define FILTER_TYPE_COUNT 6

typedef enum {
	SinaUCFilterIncoming = 0,   // Content we are receiving
	SinaUCFilterOutgoing		// Content we are sending
} SinaUCFilterDirection;
...
/*@protocol SinaUCContentFilter, SinaUCDelayedContentFilter, SinaUCHTMLContentFilter;
@protocol SinaUCMessageEncryptor;

@class SinaUCAccount, AIChat, SinaUCListContact, SinaUCListObject, SinaUCContentObject;
@class AIContentMessage;

@protocol SinaUCContentController <SinaUCController>
//Typing
 ...
 */
@protocol SinaUCHTMLContentFilter
/*!
 ...
 */
@protocol SinaUCDelayedContentFilter
/*!
...
/*@protocol SinaUCMessageEncryptor <NSObject>
